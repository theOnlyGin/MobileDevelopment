...
import ru.mirea.kokuevdd.cryptoloader.databinding.ActivityMainBinding;
...
public	class	MainActivity	extends	AppCompatActivity		implements
    ...
    public void onClickButton(View view) {
        String text = String.valueOf(binding.editTextMirea.getText());

        Bundle bundle = new Bundle();
        SecretKey secret = generateKey();
        byte[] bytes = encryptMsg(text, secret);
